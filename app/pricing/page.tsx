      ...
      <section className="py-20 md:py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Choose the plan that fits your company’s size and website needs. All plans include our core content management, workflow, and enterprise-grade publishing features.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 border border-gray-300">
              ...
              <p className="text-gray-600 mb-6">Perfect for Small businesses and Startups - $19/month (billed annually $228 → $180) 21% Discount</p>
              <div className="mb-8">
                <span className="text-4xl font-serif font-light text-black">$19</span>
              ...
              <ul className="space-y-3 text-gray-600 mb-8">
                ...
                <li className="flex items-start">
                  <span className="text-black mr-3">✓</span>
                  Unlimited articles and blog publishing
                </li>
                <li className="flex items-start">
                  <span className="text-black mr-3">✓</span>
...
$29/month (billed annually $348 → $300) 14% Discount</p>
              ...
              <ul className="space-y-3 text-gray-600 mb-8">
                ...
                <li className="flex items-start">
                  <span className="text-black mr-3">✓</span>
                  Advanced content management with component-based layouts
                ...
                <li className="flex items-start">
                  <span className="text-black mr-3">✓</span>
                  Custom workflow and page management
                </li>
                <li className="flex items-start">
                  <span className="text-black mr-3">✓</span>
                  Premium Dashboard
...
$49/month (billed annually $588 → $480) 18% Discount</p>
              ...
              <ul className="space-y-3 text-gray-600 mb-8">
                <li className="flex items-start">
                  <span className="text-black mr-3">✓</span>
                  Max 150 pages (Sub pages not included)
                </li>
                <li className="flex items-start">
                  <span className="text-black mr-3">✓</span>
                  Unlimited dynamic content and page publishing
                </li>
                <li className="flex items-start">
                  <span className="text-black mr-3">✓</span>
                  Custom analytics and performance reporting
                </li>
                <li className="flex items-start">
                  <span className="text-black mr-3">✓</span>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-serif font-light text-black mb-16 text-center">Pages Included</h2>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="text-gray-600">
                <tr className="border-b border-gray-200">
                  ...
                  <td className="py-4 px-6 text-center">150 Pages</td>
                </tr>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Yes! BroadPress offers a 14-day free trial for all plans. No credit card is required to get started.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Absolutely. You can upgrade or downgrade your plan at any time, and changes take effect immediately.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                We accept all major credit cards, bank transfers, and can provide custom billing arrangements for Enterprise customers.
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                No setup fees for Starter and Professional plans. Enterprise customers receive white-glove onboarding included in their custom pricing.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-12">
            Join businesses across industries who trust BroadPress to streamline corporate website management, content publishing, and enterprise workflows.
